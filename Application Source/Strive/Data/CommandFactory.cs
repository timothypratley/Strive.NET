...
namespace Strive.Data
{
	...
	public class CommandFactory
	{
		...
		public System.Data.SqlClient.SqlCommand SelectEquipable
		{
			get
			{
				return buildCommandFromSimpleQuery("SELECT * FROM Equipable");
			}
		}

		public System.Data.SqlClient.SqlCommand SelectJunk
		{
			get
			{
				return buildCommandFromSimpleQuery("SELECT * FROM Junk");
			}
		}

		public System.Data.SqlClient.SqlCommand SelectMobile
		{
			get
			{
				return buildCommandFromSimpleQuery("SELECT * FROM Mobile");
			}
		}

		public System.Data.SqlClient.SqlCommand SelectQuaffable
		{
			get
			{
				return buildCommandFromSimpleQuery("SELECT * FROM Quaffable");
			}
		}

		public System.Data.SqlClient.SqlCommand SelectTerrain
		{
			get
			{
				return buildCommandFromSimpleQuery("SELECT * FROM Terrain");
			}
		}

		public System.Data.SqlClient.SqlCommand SelectWieldable
		{
			get
			{
				return buildCommandFromSimpleQuery("SELECT * FROM Wieldable");
			}
		}
