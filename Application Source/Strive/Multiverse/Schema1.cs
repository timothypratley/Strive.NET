...
namespace Strive.Multiverse {
    ...
    public class Schema : DataSet {
        ...
        private Player1DataTable tablePlayer1;
        ...
        protected Schema(SerializationInfo info, StreamingContext context) {
            ...
            if ((strSchema != null)) {
                ...
                if ((ds.Tables["Player1"] != null)) {
                    this.Tables.Add(new Player1DataTable(ds.Tables["Player1"]));
                }
        ...
        [System.ComponentModel.Browsable(false)]
        [System.ComponentModel.DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Content)]
        public Player1DataTable Player1 {
            get {
                return this.tablePlayer1;
            }
        }
        ...
        internal void InitVars() {
            ...
            this.tablePlayer1 = ((Player1DataTable)(this.Tables["Player1"]));
            if ((this.tablePlayer1 != null)) {
                this.tablePlayer1.InitVars();
            }
        }
        ...
        private void InitClass() {
            ...
            this.tablePlayer1 = new Player1DataTable();
            this.Tables.Add(this.tablePlayer1);
        }
        ...
        private bool ShouldSerializePlayer1() {
            return false;
        }
        ...
        public delegate void Player1RowChangeEventHandler(object sender, Player1RowChangeEvent e);
        ...
        [System.Diagnostics.DebuggerStepThrough()]
        public class Player1DataTable : DataTable, System.Collections.IEnumerable {
            ...
            internal Player1DataTable() : 
                    base("Player1") {
                this.InitClass();
            }
            
            internal Player1DataTable(DataTable table) : 
                    base(table.TableName) {
                if ((table.CaseSensitive != table.DataSet.CaseSensitive)) {
                    this.CaseSensitive = table.CaseSensitive;
                }
            ...
            public Player1Row this[int index] {
                get {
                    return ((Player1Row)(this.Rows[index]));
                }
            }
            
            public event Player1RowChangeEventHandler Player1RowChanged;
            
            public event Player1RowChangeEventHandler Player1RowChanging;
            
            public event Player1RowChangeEventHandler Player1RowDeleted;
            
            public event Player1RowChangeEventHandler Player1RowDeleting;
            
            public void AddPlayer1Row(Player1Row row) {
                this.Rows.Add(row);
            }
            
            public Player1Row AddPlayer1Row(string Email, string Password) {
                Player1Row rowPlayer1Row = ((Player1Row)(this.NewRow()));
                rowPlayer1Row.ItemArray = new object[] {
                        null,
                        Email,
                        Password};
                this.Rows.Add(rowPlayer1Row);
                return rowPlayer1Row;
            }
            
            public Player1Row FindByPlayerID(int PlayerID) {
                return ((Player1Row)(this.Rows.Find(new object[] {
                            PlayerID})));
            }
            ...
            public override DataTable Clone() {
                Player1DataTable cln = ((Player1DataTable)(base.Clone()));
                cln.InitVars();
                return cln;
            }
            
            protected override DataTable CreateInstance() {
                return new Player1DataTable();
            }
            ...
            public Player1Row NewPlayer1Row() {
                return ((Player1Row)(this.NewRow()));
            }
            
            protected override DataRow NewRowFromBuilder(DataRowBuilder builder) {
                return new Player1Row(builder);
            }
            
            protected override System.Type GetRowType() {
                return typeof(Player1Row);
            }
            
            protected override void OnRowChanged(DataRowChangeEventArgs e) {
                base.OnRowChanged(e);
                if ((this.Player1RowChanged != null)) {
                    this.Player1RowChanged(this, new Player1RowChangeEvent(((Player1Row)(e.Row)), e.Action));
                }
            }
            
            protected override void OnRowChanging(DataRowChangeEventArgs e) {
                base.OnRowChanging(e);
                if ((this.Player1RowChanging != null)) {
                    this.Player1RowChanging(this, new Player1RowChangeEvent(((Player1Row)(e.Row)), e.Action));
                }
            }
            
            protected override void OnRowDeleted(DataRowChangeEventArgs e) {
                base.OnRowDeleted(e);
                if ((this.Player1RowDeleted != null)) {
                    this.Player1RowDeleted(this, new Player1RowChangeEvent(((Player1Row)(e.Row)), e.Action));
                }
            }
            
            protected override void OnRowDeleting(DataRowChangeEventArgs e) {
                base.OnRowDeleting(e);
                if ((this.Player1RowDeleting != null)) {
                    this.Player1RowDeleting(this, new Player1RowChangeEvent(((Player1Row)(e.Row)), e.Action));
                }
            }
            
            public void RemovePlayer1Row(Player1Row row) {
                this.Rows.Remove(row);
            }
        }
        
        [System.Diagnostics.DebuggerStepThrough()]
        public class Player1Row : DataRow {
            
            private Player1DataTable tablePlayer1;
            
            internal Player1Row(DataRowBuilder rb) : 
                    base(rb) {
                this.tablePlayer1 = ((Player1DataTable)(this.Table));
            }
            
            public int PlayerID {
                get {
                    return ((int)(this[this.tablePlayer1.PlayerIDColumn]));
                }
                set {
                    this[this.tablePlayer1.PlayerIDColumn] = value;
                }
            }
            
            public string Email {
                get {
                    return ((string)(this[this.tablePlayer1.EmailColumn]));
                }
                set {
                    this[this.tablePlayer1.EmailColumn] = value;
                }
            }
            
            public string Password {
                get {
                    return ((string)(this[this.tablePlayer1.PasswordColumn]));
                }
                set {
                    this[this.tablePlayer1.PasswordColumn] = value;
                }
            }
        }
        
        [System.Diagnostics.DebuggerStepThrough()]
        public class Player1RowChangeEvent : EventArgs {
            
            private Player1Row eventRow;
            
            private DataRowAction eventAction;
            
            public Player1RowChangeEvent(Player1Row row, DataRowAction action) {
                this.eventRow = row;
                this.eventAction = action;
            }
            
            public Player1Row Row {
                get {
                    return this.eventRow;
                }
            }
