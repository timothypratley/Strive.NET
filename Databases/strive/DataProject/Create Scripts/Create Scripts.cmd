...
bcp "%2.dbo.Area" in "dbo.Area.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.Clan.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.Clan" in "dbo.Clan.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.ClanRank.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.ClanRank" in "dbo.ClanRank.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
...
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.EnumSize.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.EnumSize" in "dbo.EnumSize.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
...
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.EquipableItem.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.EquipableItem" in "dbo.EquipableItem.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.Inventory.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.Inventory" in "dbo.Inventory.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.ItemPhysicalObject.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.ItemPhysicalObject" in "dbo.ItemPhysicalObject.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.JunkItem.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.JunkItem" in "dbo.JunkItem.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.MobileHasClanRank.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.MobileHasClanRank" in "dbo.MobileHasClanRank.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.MobileHasSkill.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.MobileHasSkill" in "dbo.MobileHasSkill.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.MobileHasSpecialisation.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.MobileHasSpecialisation" in "dbo.MobileHasSpecialisation.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.MobilePhysicalObject.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.MobilePhysicalObject" in "dbo.MobilePhysicalObject.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.MobilePossesableByPlayer.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.MobilePossesableByPlayer" in "dbo.MobilePossesableByPlayer.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.PhysicalObject.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.PhysicalObject" in "dbo.PhysicalObject.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.PhysicalObjectAffectedBySkill.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.PhysicalObjectAffectedBySkill" in "dbo.PhysicalObjectAffectedBySkill.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.Player.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.Player" in "dbo.Player.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.QuaffableItem.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.QuaffableItem" in "dbo.QuaffableItem.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.Race.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.Race" in "dbo.Race.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.RaceHasEmote.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.RaceHasEmote" in "dbo.RaceHasEmote.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.ReadableItem.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.ReadableItem" in "dbo.ReadableItem.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.RespawnPoint.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.RespawnPoint" in "dbo.RespawnPoint.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.SkillEnablesSkill.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.SkillEnablesSkill" in "dbo.SkillEnablesSkill.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.SpecialisationEnablesSkill.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.SpecialisationEnablesSkill" in "dbo.SpecialisationEnablesSkill.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.SpecialisationEnablesSpecialisation.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.SpecialisationEnablesSpecialisation" in "dbo.SpecialisationEnablesSpecialisation.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.TerrainPhysicalObject.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.TerrainPhysicalObject" in "dbo.TerrainPhysicalObject.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.WieldableItem.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.WieldableItem" in "dbo.WieldableItem.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.World.tab"
if %ERRORLEVEL% NEQ 0 goto errors
bcp "%2.dbo.World" in "dbo.World.dat" -S %1 -T -k -n -q
if %ERRORLEVEL% NEQ 0 goto errors
...
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.EnumSize.kci"
if %ERRORLEVEL% NEQ 0 goto errors
...
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.EquipableItem.kci"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.Inventory.kci"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.ItemPhysicalObject.kci"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.JunkItem.kci"
if %ERRORLEVEL% NEQ 0 goto errors
...
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.MobilePhysicalObject.kci"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.MobilePossesableByPlayer.kci"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.PhysicalObject.kci"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.PhysicalObjectAffectedBySkill.kci"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.Player.kci"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.QuaffableItem.kci"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.Race.kci"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.RaceHasEmote.kci"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.ReadableItem.kci"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.RespawnPoint.kci"
if %ERRORLEVEL% NEQ 0 goto errors
...
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.TerrainPhysicalObject.kci"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.WieldableItem.kci"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.World.kci"
if %ERRORLEVEL% NEQ 0 goto errors


osql -S %1 -d %2 -E -b -i "dbo.Equipable.viw"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.Junk.viw"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.Mobile.viw"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.PhysicalObjectInstance.viw"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.Quaffable.viw"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.QuaffableItems.viw"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.Terrain.viw"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.Wieldable.viw"
if %ERRORLEVEL% NEQ 0 goto errors
...
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.CreateMobileMirror.prc"
if %ERRORLEVEL% NEQ 0 goto errors
osql -S %1 -d %2 -E -b -i "dbo.CreateQuaffable.prc"
if %ERRORLEVEL% NEQ 0 goto errors
