...
namespace Strive.Rendering.TV3D.Models {
	...
	public class Terrain : ITerrain {
		...
		public static ITerrain CreateTerrain( string name, ITexture texture, float y, float xy, float zy, float xzy ) {
			...
			t._mesh.AddTriangle( texture.ID, 0, y, 0, 0, zy, 100, 100, xzy, 100, 1, 1, true, false /* todo: should be false */ );
			t._mesh.AddTriangle( texture.ID, 100, xzy, 100, 100, xy, 0, 0, y, 0, 1, 1, true, false /* todo: should be false */ );
			return t;
		}
