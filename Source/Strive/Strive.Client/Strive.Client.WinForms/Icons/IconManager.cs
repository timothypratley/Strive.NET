...
namespace Strive.Client.WinForms.Icons
{
	/// <summary>
	...
	public class IconManager
	{
		...
		private static Bitmap GetAsBitmap(string iconname)
		{
			...
			Assembly myAssembly = 
				Assembly.GetAssembly(Type.GetType("Strive.Client.WinForms.Icons.IconManager"));
 
			// Get the resource stream containing the embedded resource
			Stream imageStream = 
				myAssembly.GetManifestResourceStream("Strive.Client.Winforms.Icons." + iconname + ".bmp");
