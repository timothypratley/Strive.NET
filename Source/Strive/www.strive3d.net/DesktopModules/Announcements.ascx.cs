...
namespace www.strive3d.net {
    ...
    public abstract class Announcements : www.strive3d.net.PortalModuleControl {
        ...
        // server control.  It uses the www.strive3d.net.AnnouncementsDB()
        ...
        private void Page_Load(object sender, System.EventArgs e) {
            ...
            www.strive3d.net.AnnouncementsDB announcements = new www.strive3d.net.AnnouncementsDB();
