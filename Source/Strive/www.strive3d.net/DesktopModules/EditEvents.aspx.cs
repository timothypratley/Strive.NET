...
namespace www.strive3d.net {
    ...
    public class EditEvents : System.Web.UI.Page {
        ...
        //
        // It then uses the www.strive3d.net.EventsDB() data component
        ...
        // create or update an event.  It uses the www.strive3d.net.EventsDB()
        ...
        // an event.  It  uses the www.strive3d.net.EventsDB() data component to
